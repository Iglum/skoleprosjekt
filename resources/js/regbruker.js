function regBruker() {
    ...
    html +=
        ...
        <div onclick="mainHTML.innerHTML = regKunde()" style="background-color: #F8F8F8; border: 1px solid #C6C6C6; width: 90%; margin: auto; margin-top: 100px; padding: 20px 10px 20px 10px;">
