function minside(innloggetbedrift) {
  ...
  html +=
  `
    <button onclick='mainHTML.innerHTML = kartside(${innloggetbedrift})' style='display: inline-block; background-color: #0B91E5; border: none; font-size: 25px; color: white; width: 30px;'>⤶</button>
    <h2 style='width: 100%; display: inline-block; color: white'>Min Side</h2>" 
